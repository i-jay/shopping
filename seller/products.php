...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['deleteId'])) {
        ...
        $sql = "INSERT INTO `products` ( `product_cat_id`, `product_image` , `product_name`, `product_info`, `product_quantity`, `product_cat_name`, `seller_id`, `product_seller`, `product_price`,`product_keywords`, `created_at` ) VALUES ('$pcat_id', '$folder' ,'$pname', '$pinfo', '$quantity', '$category', '$seller_id', 'amazon', '$price', '$keyword', current_timestamp())";
        $result = mysqli_query($conn, $sql);
...
<head>
    ...
    <title>Seller Products - Shopping </title>
                            ...
                            <div class="card my-4">
                                ...
                                <div class="card-body">
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql2 = "SELECT * FROM `products` WHERE `seller_id` = '$seller_id'";
                                            $result2 = mysqli_query($conn, $sql2);
                                            $srno2 = 0;
