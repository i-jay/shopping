...
<head>
    ...
    <title>Seller Login - Shopping</title>
    <style>
...
<body>
    ...
    <div class="container mt-4 pt-3 d-flex align-items-center justify-content-center flex-column">
        <h2 class="text-center my-4 mb-0 account">Login for Seller</h2>
        <form class="align-items-center form my-2" method="post" action="sellerlogin.php">
            <div class="form-col">
